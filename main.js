  ...
  if(use_container == "true")
  {
    ...
    docker.pull(docker_image, function(err, stream)
    {
      ...
      function onFinished(err, output)
      {
        ...
        console.log([godot_executable, ...flags, '--import', '-s', '--path', '/project', 'addons/gut/gut_cmdln.gd']);
        docker.run(docker_image, [godot_executable, ...flags, '--import', '-s', '--path', '/project', 'addons/gut/gut_cmdln.gd'], process.stdout,
        console.log([godot_executable, ...flags, '-s', '--path', '/project', 'addons/gut/gut_cmdln.gd']);
